...
import { Play, Pause, Square, Share2, MapPin, Activity, Timer, Navigation, Sparkles, Camera, Settings, Footprints, History, LogOut, ChevronLeft, Save, User as UserIcon, Lock, X } from 'lucide-react';
...
export default function App() {
  ...
  const generateCaption = async (d: number, t: number, p: string, type: string) => {
    ...
    const prompt = `Crie uma legenda curta e vibrante (max 15 palavras) para Stories sobre minha ${activityName}: ${d.toFixed(2)}km, pace ${p}. Use emojis.`;
  ...
  const startTracking = () => {
    ...
    watchId.current = navigator.geolocation.watchPosition(
      ...
      console.error, { enableHighAccuracy: true, distanceFilter: 2 }
    );
  };
